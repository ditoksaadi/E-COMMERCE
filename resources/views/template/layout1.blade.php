...
<head>
    <title>Sublime | @yield('title')</title>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="description" content="Sublime project" />
    <link rel="icon" href="{{ url('  sublime/images/logo.png') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('sublime/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}" />
...
<body>
    <div class="super_container animate__animated animate__fadeIn">
        <!-- Header -->
        @if (session('success'))
        ...
        <header class="header">
            <div class="header_container">
             ...
             c0,7.5,6,13.5,13.5,13.5s13.5-6,13.5-13.5v-41h45.2l26.9,302.3C412.8,445.2,392.1,462,366.8,462z" />
                                            ...
                                            @php
                                                ...
                                                $cart = DB::table('carts')->where('id_user', $id_user)->count();
                                            @endphp

                                            @if (Auth::check())
                                                <div>Cart <span> ( {{ $cart }} ) </span></div>
                                            @else
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                                <form action="{{ url('produk/search') }}" method="GET" role="search">
            ...
            <div class="header_social">
                <ul>
                    ...
                    @if (Auth::check())
                        <li class="hassubs">
                            <a class=" fw-bold text-dark"> {{ session('name') }} </a>
                            <ul>
                                <li>
                    ...
                    @else
                        <li>
                            <a class="fw-bold text-dark" href="{{ url('auth') }}"><i class="bi bi-box-arrow-right"
    ...
    <script>
        $(document).ready(function() {
            ...
            Notifikasi menghilang setelah 5 detik
        });
