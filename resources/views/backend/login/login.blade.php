...
<head>
    ...
    <title>SUBLIME | ADMIN LOGIN </title>
    <style>
        body {
            background: #fffcfc;
        }
...
<body>
    ...
    <div class="container">
        <form action="{{ url('proses') }}" method="POST" class="form_container">
            @csrf
            ...
            <div class="title_container">
                <p class="title">Login to your Admin Account</p>
            ...
            <div class="input_container">
                <form action="">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="email" type="text"
            ...
            <a href="{{ url('forgot_password') }}" class="note">Forgot your pas sword</a>
            <div class="separator">
                <hr class="line">
                <span>Or</span>
                <hr class="line">
            </div>
            <a href="{{ url('register') }}" class="note">Register</a>
        </form>
    </div>
</body>
