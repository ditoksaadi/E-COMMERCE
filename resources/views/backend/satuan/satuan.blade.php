            ...
            <div class="container-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="table1" class="table1 table table-striped table-hover dataTable">
                                ...
                                @foreach ($satuan as $item => $value)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center gap-3">
                                            ...
                                            <form action="{{ route('satuan.destroy', ['satuan' => $value->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal fade" id="modal-lg-{{ $value->id }}">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{-- input form --}}
                        <form action="{{ route('satuan.update', ['satuan' => $value->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="exampleInputEmail1">Masukan Nama</label>
